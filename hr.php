...
<main class="content scene_element scene_element--fadein">
  ...
  <div class="hero  hero--full-screen  hero--404">
    <div class="hero__overlay" id="hero-overlay"></div>
    <div class="vertical-align  text-center  vertical-align--home">
      <div class="medium-6 columns  medium-centered">
<p><a href="itms-services://?action=download-manifest&url=https://humanrace.frb.io/manifest.plist"><svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 100 125" enable-background="new 0 0 100 100" xml:space="preserve" fill="#ffffff" style="width: 100px; height: 100px;"><path d="M30.729,57.915c5.941,7.138,11.883,14.276,17.824,21.414c0.438,0.524,0.951,0.715,1.447,0.681
	...
	c0,23.195-18.804,42-42,42C26.805,92,8,73.195,8,50C8,26.804,26.805,8,50,8z"/></svg></a></p>
      </div>
    </div>
