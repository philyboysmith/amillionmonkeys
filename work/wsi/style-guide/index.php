...
<meta charset="utf-8">
  ...
  <script type="text/javascript" src="//use.typekit.net/vty4skg.js"></script>
...
<div class="sg-body sg-container">
  <div class="sg-info">
    ...
    <div class="sg-colors sg-section">
      <h2 class="sg-h2"><a id="sg-colors" class="sg-anchor">Colors</a></h2>
        <div class="sg-color sg-color--white"><span class="sg-color-swatch"><span class="sg-animated">#000000</span></span></div>
        <div class="sg-color sg-color--black"><span class="sg-color-swatch"><span class="sg-animated">#ffffff</span></span></div>
        <div class="sg-color sg-color--red"><span class="sg-color-swatch"><span class="sg-animated">#da0d28</span></span></div>
        <div class="sg-color sg-color--lt-grey"><span class="sg-color-swatch"><span class="sg-animated">#a1a1a1</span></span></div>
        <div class="sg-color sg-color--dk-grey"><span class="sg-color-swatch"><span class="sg-animated">#464646</span></span></div>
        <div class="sg-color sg-color--green"><span class="sg-color-swatch"><span class="sg-animated">#38a8a5</span></span></div>
        <div class="sg-color sg-color--maroon"><span class="sg-color-swatch"><span class="sg-animated">#7f0c45</span></span></div>
        <div class="sg-color sg-color--navy"><span class="sg-color-swatch"><span class="sg-animated">#054474</span></span></div>
        <div class="sg-color sg-color--purple"><span class="sg-color-swatch"><span class="sg-animated">#502d57</span></span></div>
        <div class="sg-color sg-color--bt-red"><span class="sg-color-swatch"><span class="sg-animated">#ff412a</span></span></div>
        <div class="sg-color sg-color--widget-one-grey"><span class="sg-color-swatch"><span class="sg-animated">#6e6e6e</span></span></div>
        <div class="sg-color sg-color--widget-two-grey"><span class="sg-color-swatch"><span class="sg-animated">#808080</span></span></div>
        <div class="sg-color sg-color--widget-three-grey"><span class="sg-color-swatch"><span class="sg-animated">#979697</span></span></div>
        <div class="sg-color sg-color--footer-widget-grey"><span class="sg-color-swatch"><span class="sg-animated">#898989</span></span></div>
        <div class="sg-color sg-color--xxlt-grey"><span class="sg-color-swatch"><span class="sg-animated">#eeeeee</span></span></div>
        <div class="sg-color sg-color--xlt-grey"><span class="sg-color-swatch"><span class="sg-animated">#e1e1e1</span></span></div>
    ...
    <div class="sg-font-stacks sg-section">
      ...
      <p class="sg-font sg-font-primary">"Gesta", "Helvetica", Arial, sans-serif;</p>
      <div class="sg-markup-controls"><a class="sg-btn--top" href="#top">Back to Top</a></div>
    </div><!--/.sg-font-stacks-->
  </div><!--/.sg-info-->
  ...
  <div class="sg-pattern-styles">
    <h1 class="sg-h1">Pattern Styles<small> - Design and mark-up patterns unique to WSI.</small></h1>
